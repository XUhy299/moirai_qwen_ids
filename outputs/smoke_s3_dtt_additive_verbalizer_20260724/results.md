# smoke_s3_dtt_additive_verbalizer_20260724
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 1.5942 | 0.0000 | 0.4167 | 0.5000 | 1.0000 | 0.6667 | 1.0000 | 0.3634 | 3.9906 | 1.3766 |

## 当前最佳

- Epoch：1
- 选模指标 `vocab_pr_auc`：0.4167
- ROC-AUC：0.0000
- PR-AUC：0.4167
- Precision / Recall / F1：0.5000 / 1.0000 / 0.6667
- FPR / FNR：1.0000 / 0.0000
- 峰值CUDA显存：4994.2490 MB
